    ...
    public struct BattlefieldControlActions
    {
        ...
        public void SetCallbacks(IBattlefieldControlActions instance)
        {
            if (m_Wrapper.m_BattlefieldControlActionsCallbackInterface != null)
            {
                ...
                @BoxSelect.started -= m_Wrapper.m_BattlefieldControlActionsCallbackInterface.OnBoxSelect;
                @BoxSelect.performed -= m_Wrapper.m_BattlefieldControlActionsCallbackInterface.OnBoxSelect;
                @BoxSelect.canceled -= m_Wrapper.m_BattlefieldControlActionsCallbackInterface.OnBoxSelect;
            }
